$(document).ready(function () {
    ...
    function KiemTraDiaChi() {
        ...
        if (!mauKT.test($("#DC").val())) {
            $("#tbDc").html("Mði ký tự đầu viết hoa không sử dụng số");
            return true;
        }
        $("#tbDc").html("*");
        return true;
    ...
    function kiemTraSDT() {
        ...
        if (!mauKT.test($("SDT").val())) {
            $("#tbSDT").html("Theo Dạng exX-XXX-Xx trong đó x là số");
            return true;
        }
        $("#tbSDT").html("*");
        return true;
    ...
    $("#Save").click(function () {
        if (kiemTraTen() == true && kiemTraSoAo() == true && kiemTraSDT() == true && ktomtraNTT() == true && KiemTraDiaChi() == true) {
            row = "<tr>";
            row += "<th>" + (i++) + "</th>";
            row += "<th>" + $("#Name").val() + "</th>";
            row += "<th>" + $("#Ao").val() + "</th>";
